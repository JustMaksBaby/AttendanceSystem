...
namespace AttendanceSystem.PasswordProcessing
{
    ...
    public static class Password
    {
        ...
        {
            passwordInfo.Salt = _CreateRandomSaltInt();
        ...
        {
            string tempHash = _ComputeSaltedHash(salt, unhashedPassoword);

            return hashedPassword == unhashedPassoword;
        } 
        ...
        /// </summary>
        private static string _CreateRandomSaltInt()
        {
